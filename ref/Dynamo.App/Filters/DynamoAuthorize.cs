...
namespace Dynamo.App.Filters
{
    public class DynamoAuthorize : AuthorizeAttribute, IAsyncAuthorizationFilter
    {
        ...
        public virtual async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            OnReadAuthorizations(userId, userName, lang, type, typeId);
        ...
        protected virtual void OnReadAuthorizations(string userId, string userName, string lang, string type, string typeId)
        {
