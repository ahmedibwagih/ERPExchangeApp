...
{
    public class IdentitySourcesService : BaseService<IdentitySources, IdentitySourcesDto, IdentitySourcesDto, IdentitySourcesDto, IdentitySourcesDto>, IIdentitySourcesService
    {
        private readonly DynamoSession session;

        public IdentitySourcesService(IUnitOfWork unitOfWork,
       DynamoSession session) : base(unitOfWork)
        ...
        public override async Task<IdentitySourcesDto> GetById(long id)
        {
